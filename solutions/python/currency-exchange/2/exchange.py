...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    exchange_final_rate = exchange_rate + exchange_fee
    exchange_value = exchange_money(budget, exchange_final_rate)
    number_of_bills = get_number_of_bills(exchange_value, denomination)
    max_value =  get_value_of_bills(number_of_bills, denomination)
    return max_value
